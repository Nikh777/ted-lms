...
export const adminEndpoints = {
  ...
  ADMIN_REQUESTS_API: BASE_URL + "/admin/instructor-requests",
  ADMIN_APPROVE_INSTRUCTOR_API: BASE_URL + "/admin/instructor/approve",
  ADMIN_REJECT_INSTRUCTOR_API: BASE_URL + "/admin/instructor/reject",
...
export const instructorApplicationEndpoints = {
  APPLY_INSTRUCTOR_API: BASE_URL + "/instructor/apply",
